                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
										...
										<th>Barrios Id Barrio</th>
										<th>Solicitudes Ciudadanos Id Solicitud</th>
										<th>Solicitudes Empresas Id Solicitud</th>
                                ...
                                <tbody>
                                    @foreach ($rutas as $ruta)
                                        <tr>
											...
											<td>{{ $ruta->horario_ruta }}</td>
											<td>{{ $ruta->fecha_ruta }}</td>
											<td>{{ $ruta->Ruta_realizada }}</td>
											<td>{{ $ruta->recicladoras_Id_recicladora }}</td>
											<td>{{ $ruta->barrios_id_barrio }}</td>
											<td>{{ $ruta->solicitudes_ciudadanos_id_solicitud }}</td>
											<td>{{ $ruta->solicitudes_empresas_id_solicitud }}</td>
											<td>{{ $ruta->Motivo_cancelacion }}</td>
